  ...
  return (
    <div className="mx-auto max-w-xl space-y-6">
      <Card className="border border-slate-200 p-6 text-center sm:p-8">
        ...
        <div>
          <h3 className="text-lg font-black text-slate-900">رفع ملف الحركات</h3>
      ...
      {result && (
        <Card className="border border-slate-200 p-5 space-y-4">
          <div className="flex items-center gap-2">
            ...
            <h4 className="text-base font-black text-slate-900">اكتمل الاستيراد</h4>
          </div>
          ...
          {result.notFoundRows.length > 0 && (
            <div className="rounded-md border border-amber-200 bg-amber-50 p-4">
              <div className="flex items-start justify-between gap-3">
                ...
                <Button
                  variant="outline"
                  className="shrink-0 h-9 border-amber-300 bg-amber-100 text-amber-800 hover:bg-amber-200"
