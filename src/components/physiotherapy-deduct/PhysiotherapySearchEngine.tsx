...
export function PhysiotherapySearchEngine() {
  const {
    searchInput,
    setSearchInput,
    setCardNumber,
      ...
      <Card className="p-2">
        <form onSubmit={handleSearch} className="flex flex-col gap-3 sm:flex-row">
          <div className="relative flex-1" ref={searchBoxRef}>
            <Input
              id="physiotherapy-beneficiary-search"
              name="physiotherapy-beneficiary-search"
              aria-label="البحث عن مستفيد في خدمات العلاج الطبيعي"
              value={searchInput}
              onChange={(e) => {
