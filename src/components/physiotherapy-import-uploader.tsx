...
/**
 * PhysiotherapyImportUploader
 * ====================
 * نافذة استيراد مستفيدي شركات العلاج الطبيعي — مشابهة لـ ImportUploader
...
export function PhysiotherapyImportUploader({ companies }: Props) {
  ...
  return (
    <div className="space-y-6 max-w-xl mx-auto">
      <Card className="border border-slate-200 dark:border-slate-800 p-6 text-center sm:p-8">
        ...
        <input type="file" id="physiotherapy-file-upload" className="hidden" accept=".xlsx,.xls" onChange={handleFileChange} />

        <div className="mx-auto mt-5 flex w-full max-w-sm flex-col items-center space-y-3">
          <label
            htmlFor="physiotherapy-file-upload"
