...
/**
 * EquestrianImportUploader
 * ====================
 * نافذة استيراد مستفيدي شركات الفروسية — مشابهة لـ ImportUploader
...
export function EquestrianImportUploader({ companies }: Props) {
  ...
  return (
    <div className="space-y-6 max-w-xl mx-auto">
      <Card className="border border-slate-200 dark:border-slate-800 p-6 text-center sm:p-8">
        ...
        <input type="file" id="equestrian-file-upload" className="hidden" accept=".xlsx,.xls" onChange={handleFileChange} />

        <div className="mx-auto mt-5 flex w-full max-w-sm flex-col items-center space-y-3">
          <label
            htmlFor="equestrian-file-upload"
