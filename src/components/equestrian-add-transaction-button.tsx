...
import { EquestrianAddTransactionModal } from "./equestrian-add-transaction-modal";
...
export function EquestrianAddTransactionButton({
  companyId,
  companyName,
  facilities,
  defaultFacilityId,
  ...
  return (
    <>
      ...
      <EquestrianAddTransactionModal
        ...
        equestrianSettings={equestrianSettings}
      />
    </>
  );
}
