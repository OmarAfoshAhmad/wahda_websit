...
export const PERMISSION_DEFINITIONS: ReadonlyArray<PermissionDefinition> = [
  ...
  { key: "view_beneficiaries", label: "عرض قائمة المستفيدين", group: "beneficiaries" },
  ...
  { key: "correct_transactions", label: "تصحيح الحركات لأي مرفق (القيمة والنوع والمرفق)", group: "transactions" },
  { key: "delete_transaction", label: "حذف الحركات المالية", group: "transactions" },
  ...
  { key: "cash_claim", label: "صلاحية الكاش العائلي", group: "operations" },
  { key: "cash_claim_import", label: "استيراد حركات الكاش كليم (كشف/أدوية)", group: "operations" },
  { key: "manage_card_numbering", label: "إدارة ترقيم البطاقات (استيراد ومعاينة)", group: "admin" },
  { key: "migrate_card_numbering", label: "ترحيل أرقام البطاقات (تنفيذ نهائي)", group: "admin" },

  { key: "manage_users", label: "إدارة الحسابات (إنشاء، تعديل، حذف، صلاحيات)", group: "admin" },
  { key: "manage_db_anomalies", label: "إدارة المشاكل ومعالجة أخطاء النظام", group: "admin" },
  { key: "manage_backup", label: "النسخ الاحتياطي واستعادة البيانات", group: "admin" },
];
