...
// ─── معرّفات الشركات الجوهرية ─────────────────────────────────────────────────
/**
 * معرف شركة مصرف الوحدة — الجهة الضامنة للخدمات العامة (كشف + دواء).
 * كل المستفيدين الذين لديهم company_id = null أو هذا المعرف
 * يعتبرون من منتسبي مصرف الوحدة.
 *
 * ⚠️ لتغيير الشركة الرئيسية: غيّر هذا الثابت فقط.
 */
export const WAHDA_BANK_COMPANY_ID = "cmp7ha2km0000u9v8jse4ib5x";
...
export const AUDIT_ACTIONS = {
  ...
  CEILING_EXCEEDED_FIX: "CEILING_EXCEEDED_FIX",
} as const;
