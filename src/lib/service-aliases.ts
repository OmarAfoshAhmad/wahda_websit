export function getServiceAlias(company: { service_aliases?: any } | null | undefined, serviceType: 'DENTAL' | 'OPTICS' | 'PHYSIOTHERAPY' | 'EQUESTRIAN', defaultName: string): string {
