...
export async function GET(request: Request) {
  ...
  const sheetName = getServiceAlias(firstCompany, 'PHYSIOTHERAPY', "حركات العلاج الطبيعي");
  ...
  ws.columns = [
    ...
    { header: "عدد الجلسات", key: "amount", width: 16 },
    { header: "الجلسات المغطاة", key: "company_share", width: 16 },
    { header: "الجلسات الزائدة", key: "patient_share", width: 16 },
  ...
  const aliasName = getServiceAlias(firstCompany, 'PHYSIOTHERAPY', "بصريات");
