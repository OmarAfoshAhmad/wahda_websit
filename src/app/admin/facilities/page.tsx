                ...
                <table className="w-full text-left border-collapse">
                  <thead className="bg-slate-50 dark:bg-slate-800/50 border-b border-slate-200 dark:border-slate-800">
                    <tr>
                      ...
                      <th className="px-5 py-3 text-center text-xs font-black text-slate-500 dark:text-slate-400 uppercase">اسم المرفق</th>
                      <th className="px-5 py-3 text-center text-xs font-black text-slate-500 dark:text-slate-400 uppercase">اسم المستخدم</th>
                      <th className="px-5 py-3 text-center text-xs font-black text-slate-500 dark:text-slate-400 uppercase">العمليات</th>
                      <th className="px-5 py-3 text-center text-xs font-black text-slate-500 dark:text-slate-400 uppercase">الحالة</th>
                      <th className="px-5 py-3 text-center text-xs font-black text-slate-500 dark:text-slate-400 uppercase no-print">إجراءات</th>
                    </tr>
                  </thead>
                        ...
                        facilities.map((f, idx) => (
                          <tr key={f.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/50">
                            ...
                            <td className="px-5 py-3 text-center">
                                {f.is_admin ? (
                                  <span className="inline-flex items-center rounded-md bg-green-50 dark:bg-green-900/30 px-2 py-1 text-xs font-medium text-green-700 dark:text-green-400 ring-1 ring-inset ring-green-600/20 dark:ring-green-900/50">مشرف</span>
                                ) : (
