        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between border-b border-slate-200 dark:border-slate-800 pb-5">
          <div>
            <div className="flex items-center gap-2 mb-1">
              <Link
                href={initialCompanyId ? `/admin/dental-services/${initialCompanyId}` : "/admin/dental-transactions"}
              ...
              <h1 className="text-2xl font-black text-slate-900 dark:text-white">
                {initialCompanyId 
                  ...
                  : "استيراد حركات الأسنان لشركة محددة"}
              </h1>
            </div>
            <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
              {initialCompanyId 
                ? "استيراد وتحديث حركات الأسنان التاريخية لمنتسبي هذه الشركة المحددة فقط عبر ملف Excel."
