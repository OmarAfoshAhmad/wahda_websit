...
function main() {
  ...
  mapped.forEach((r) => {
    ...
    if (ben) {
      ...
      if (ben.id === '__temp__JMR2002525516S2') {
         console.log(`[Zubair matched on row ${r.rowNum}] Name: ${r.name}, Card: ${r.card}, PrevConsumed: ${consumed}`);
      }
  ...
  console.log(`Final consumption for Zubair:`, consumption['__temp__JMR2002525516S2']);
}
